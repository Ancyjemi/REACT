...
const ProjectCard = ({
  ...
  return (
    <>
      <div className="service-card w-[300px] h-[400px] shadow-xl cursor-pointer snap-start shrink-0 bg-white flex flex-col items-start gap-3 transition-all duration-300">
          ...
          <div className="h-screen w-screen absolute top-0 left-0 bg-black/20 flex justify-center items-center z-50">
            <div className=" h-[70%] w-[30%] bg-red z-50 flex flex-col  bg-white  shadow-lg ">
              <div className="w-full h-[15%] flex flex-row justify-start px-10 items-center border-2 text-green-500 bg-white text-xl font-bold shadow-sm">
                <div className="w-[55%]">Edit Your Project</div>
              ...
              <div className="w-full h-[85%] flex flex-row justify-center items-center">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="text-white bg-green-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 shadow-lg shadow-blue-500/50 dark:shadow-lg dark:shadow-blue-800/80 font-medium rounded-sm text-md px-5 py-2.5 text-center w-full h-[15%] mt-4"
                  >
                    Update Project
                  </button>
                </form>
